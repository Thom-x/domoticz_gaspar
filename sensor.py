...
class ExampleSensor(Entity):
    ...
    def update(self):
        token = login("thomas.maugin@laposte.net", "grdf.92ThoInt!!!!!!!!")
        today = datetime.date.today()
        res_month = get_data_per_month(token, dtostr(today - relativedelta(months=11)), dtostr(today))
        res_day = get_data_per_day(token, dtostr(today - relativedelta(days=1, months=1)), dtostr(today - relativedelta(days=1)))
